...
public interface SimpleLangVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code ExprBinOpExpr}
	 * labeled alternative in {@link SimpleLangParser#exp}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExprBinOpExpr(SimpleLangParser.ExprBinOpExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitGreater(SimpleLangParser.GreaterContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitGreaterEq(SimpleLangParser.GreaterEqContext ctx);
	/**
