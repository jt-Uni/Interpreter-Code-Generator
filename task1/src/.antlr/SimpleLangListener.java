...
public interface SimpleLangListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code ExprBinOpExpr}
	 * labeled alternative in {@link SimpleLangParser#exp}.
	 * @param ctx the parse tree
	 */
	void enterExprBinOpExpr(SimpleLangParser.ExprBinOpExprContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ExprBinOpExpr}
	 * labeled alternative in {@link SimpleLangParser#exp}.
	 * @param ctx the parse tree
	 */
	void exitExprBinOpExpr(SimpleLangParser.ExprBinOpExprContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterGreater(SimpleLangParser.GreaterContext ctx);
	/**
	 * Exit a parse tree produced by the {@code Greater}
	 * labeled alternative in {@link SimpleLangParser#binop}.
	 * @param ctx the parse tree
	 */
	void exitGreater(SimpleLangParser.GreaterContext ctx);
	/**
	 * Enter a parse tree produced by the {@code GreaterEq}
	 * labeled alternative in {@link SimpleLangParser#binop}.
	 * @param ctx the parse tree
	 */
	void enterGreaterEq(SimpleLangParser.GreaterEqContext ctx);
	/**
	 * Exit a parse tree produced by the {@code GreaterEq}
	 * labeled alternative in {@link SimpleLangParser#binop}.
	 * @param ctx the parse tree
	 */
	void exitGreaterEq(SimpleLangParser.GreaterEqContext ctx);
	/**
